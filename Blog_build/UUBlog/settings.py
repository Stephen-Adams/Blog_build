...
DATABASES = {
    'default': {
        ...
        'NAME': 'UUBlog',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = 'D:/Program/Python/Blog/UUBlog/media'
...
STATIC_ROOT = 'D:/Program/Python/Blog/UUBlog/static/'
...
AUTH_PROFILE_MODULE = 'UUBlog.UserProfile'