...
urlpatterns += patterns('',
    # Examples:
     ...
     url(r'^pic/$', 'UUBlog.views.pic', name='pic'),          # 图片首页
     url(r'^pic/(?P<id>\d+)/$', 'UUBlog.views.picView', name='picView'),          # 图片

     url(r'^pic/create_type/$', 'UUBlog.views.CreatePicType', name='CreatePicType'),  # create type
     url(r'^pic/upload_my_pic/(?P<id>\d+)/$', 'UUBlog.views.UploadMyPic', name='UploadMyPic'),  # up mypic
     url(r'^pic/upload/$', 'UUBlog.views.UploadPic', name='UploadPic'),  # upload
     url(r'^pic/edit_mypic/$', 'UUBlog.views.edit_mypic', name='edit_mypic'), # pic edit
